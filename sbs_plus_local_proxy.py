...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            body = ("SBS Plus proxy error: " + str(exc)).encode("utf-8")
    ...
    def proxy(self, target, root=False):
        ...
        if looks_like_playlist(final_url, content_type, body):
            ...
            body = rewrite_playlist(text, final_url).encode("utf-8")
...
if __name__ == "__main__":
    print(f"SBS Plus seamless HLS proxy listening on http://{HOST}:{PORT}/sbsplus.m3u8")
